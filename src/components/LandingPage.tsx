...
const PLANS = [
  {
    ...
    highlight: false,
    features: [
      '1 profil, 3 poches budgétaires',
      'Dépenses, revenus, calendrier et charges récurrentes',
      'Statistiques et prévision de fin de mois',
      'Cash, l’assistant IA : 15 messages par mois',
  ...
  },
  {
    ...
    highlight: true,
    features: [
      'Tout Découverte, sans limite',
      'Profils illimités',
      'Poches illimitées',
      'Cash : 300 messages IA par mois',
      'Rapports email automatiques (PDF, CSV, Excel)',
      '30 jours d’essai complet à l’inscription',
    ],
    cta: 'Essayer Premium',
  },
  {
